...
# Planner LLM — routes through Portkey gateway (retry, fallback, caching, observability)
llm = get_langchain_llm(temperature=0, metadata={"feature": "planner", "_user": "system"})
